...
class PaperExchange(ExchangeAdapter):
    """Simulation exchange without private keys or taker flows.

    Latency, queue fill probability, partial fills and cancel latency are modelled
    from `AppConfig.execution.simulator`. Orders remain maker-only and post-only.
    """
